  ...
  return (
    <div className="flex w-full items-center justify-center mx-auto">
      <Label
        ...
        className="group flex h-64 w-80 cursor-pointer flex-col items-center justify-center rounded-2xl shadow-lg transition-all hover:bg-[#1c1c1c] hover:shadow-xl bg-[#131313] mx-auto"
      >
        <div className="flex flex-col items-center justify-center p-4">
          {isLoading ? (
            ...
            <svg
              className="h-10 w-10 text-[#FFF8C6]"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 20 16"
            >
